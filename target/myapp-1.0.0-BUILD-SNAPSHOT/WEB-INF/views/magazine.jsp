...
<html>
	...
	<title>Magazine</title>
	    ...
	    <link rel="stylesheet" type="text/css" href="resources/css/hsilder.css">
	    <link rel="stylesheet" type="text/css" href="resources/css/default-style.css">
	    <script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery-2.0.3.min.js"></script>
	    <script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery.HSlider.min.js"></script>
	    <style>
	        .content.expand {
	...
	<body>
        ...
        <div class="slider">
            <section>
                <article>
                    <h2>Lorem Waldy
                        <span>Distilling design ideas and other interesting topics</span>
                    </h2>
                    <div class="content-switch">
                        <img src="resources/img/sort-down.png">
                    </div>
                </article>
                <img src="resources/img/SplitShire-6353.jpg">
                <div class="content">
                    <div class="button">
                        <img src="resources/img/sort-up.png" style="width: 100px; height: 70px;">
                    </div>
                    <h2 style="margin-bottom: 5%;">Lorem Waldy <span>Distilling design and other interesting methods</span></h2>
            ...
            <section>
                <article>
                    <h2>Round Table
                        <span>King Arthur's creative team techniques</span>
                    </h2>
                    <div class="content-switch">
                        <img src="resources/img/sort-down.png">
                    </div>
                </article>
                <img src="resources/img/photo-1519058497187-7167f17c6daf.jpg">
                <div class="content">
                    <div class="button">
                        <img src="resources/img/sort-up.png" style="width: 100px; height: 70px;">
                    </div>
                    <h2 style="margin-bottom: 5%;">Round Table <span>King Arthur's creative team techniques</span></h2>
            ...
            <section>
                <article>
                    <h2>Taking Sneezes
                        <span>Nothing is out there—let's try again</span>
                    </h2>
                    <div class="content-switch">
                        <img src="resources/img/sort-down.png">
                    </div>
                </article>
                <img src="resources/img/photo-1473972908677-002f6404ac82.jpg">
                <div class="content">
                    <div class="button">
                        <img src="resources/img/sort-up.png" style="width: 100px; height: 70px;">
                    </div>
                    <h2 style="margin-bottom: 5%;">Taking Sneezes <span>Nothing is out there—let's try again</span></h2>
