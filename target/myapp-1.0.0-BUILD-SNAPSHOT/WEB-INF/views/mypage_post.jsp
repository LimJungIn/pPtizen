...
<body class="mypage-post">
    ...
    <nav>
        <ul>
            <li><a href="#" title="post-tempalte" class="select-test"><span>28</span><br>내 템플릿</a></li>
            <li><a href="#" title="post-writing"><span>28</span><br>작성한 글</a></li>
            <li><a href="#" title="post-comment"><span>28</span><br>댓글 단 글</a></li>
        </ul>
    </nav>
