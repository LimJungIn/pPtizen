            ...
            $(document).ready(function(){
            	...
            	$("#reply_save").click(function(){
            		...
            		var reply = 
	            		...
	            		'   <input type="image"id="follow"  src="/img/default/unfollow_icon.png" value="" onclick="" />'+
	            		'</div>'+
	            		'</div>'+
	            		'</article>';
              ...
              //댓글 수정 취소
				...
				$("#like").click(function(){	
                		var objParams = {
                				id				 : $("#board_id").val(),
                				like_boardId	 : $("#board_id").val(),
                				like_getUserNickName   : $("#board_writer").val(),
        ...
        <header class="layer-header">
            ...
            <div>
                <div class="lpopup-left">
                    ...
                    <div class="nickname">
                        <a id="writer">${boardView.writer}</a>
                ...
                <a class="bttn-jelly bttn-lg bttn-default" id="like">
                	<div>
                		<div class="lpopup-like-icon"><img src="${likeCheck}" /></div>
                   		Like
					</div>
                </a>
            </div>
		   			...
		   			<c:forEach var="replyList" items="${replyList}" varStatus="status">
		   				<article class="lpopup-comment" reply_type="<c:if test="${replyList.depth == '0'}">main</c:if><c:if test="${replyList.depth == '1'}">sub</c:if>">
	                        <div class="left">
	                            ...
	                            <img class="profile" src="/img/default/default_profile.png" />
	                            <div><a class="nickname" name="nickname" nickname="${replyList.writer}">${replyList.writer}</a></div>
	                        </div>
	                        <div class="right">
	                            <div class="body">
	                            ...
	                            <div class="bottom">
					    			...
					    			<a name="reply_modify" class="modify" nickname="${replyList.writer}" parent_id = "${replyList.parent_id}" r_type = "<c:if test="${replyList.depth == '0'}">main</c:if><c:if test="${replyList.depth == '1'}">sub</c:if>" reply_id = "${replyList.reply_id}">수정</a>
					    			<a name="reply_del" class="delete" nickname="${replyList.writer}" r_type = "<c:if test="${replyList.depth == '0'}">main</c:if><c:if test="${replyList.depth == '1'}">sub</c:if>" reply_id = "${replyList.reply_id}">삭제</a>
	                            </div>
	                        </div>
                    	</article>
				    </c:forEach>
            ...
            <div class="lpopup-stats">
                ...
                <div class="stats">
                	<div class="view tag">
                        ...
                        <a href="/board/tagsearch?search=${boardView.tag1}" id="tag1">${boardView.tag1}</a>&nbsp;&nbsp;
                        <a href="/board/tagsearch?search=${boardView.tag2}" id="tag2">${boardView.tag2}</a>&nbsp;&nbsp;
                        <a href="/board/tagsearch?search=${boardView.tag3}" id="tag3">${boardView.tag3}</a>&nbsp;&nbsp;
                        <a href="/board/tagsearch?search=${boardView.tag4}" id="tag4">${boardView.tag4}</a>&nbsp;&nbsp;
                        <a href="/board/tagsearch?search=${boardView.tag5}" id="tag5">${boardView.tag5}</a>&nbsp;&nbsp;
                        <a href="/board/tagsearch?search=${boardView.tag6}" id="tag6">${boardView.tag6}</a>&nbsp;&nbsp;
                        <a href="/board/tagsearch?search=${boardView.tag7}" id="tag7">${boardView.tag7}</a>&nbsp;&nbsp;
                        <a href="/board/tagsearch?search=${boardView.tag8}" id="tag8">${boardView.tag8}</a>
                    </div>
                    <div class="view">
                        <div><img src="/img/default/view_icon_gray.png" /></div>${boardView.read_count} views
                    </div>
                    <div class="like">
                        <div><img src="/img/default/unlike_icon.png" /></div><span>${boardView.like_count} likes</span>
                    </div>
                    <div class="date">
                        <div><img src="/img/default/calendar_icon.png" /></div>${boardView.register_datetime}
                    </div>
                </div>
            </div>
            <div class="ad">
